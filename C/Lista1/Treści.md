**Zadanie 1 (10 punktów).** Program ma wyznaczyć wartość minimalną i maksymalną spośród n liczb. Wczytaj najpierw liczbę n > 10 ze standardowego wejścia a następnie wylosuj n wartości rzeczywistych x0, x1, …, xn-1 z przedziału [0, 1] i wskaż, która z wylosowanych liczb była najmniejsza a która największa. Do losowania użyj funkcji rand() z pliku nagłówkowego <stdlib.h>; funkcja rand() zwraca liczbę całkowitą, więc aby tą wartość przekształcić na liczbę zmiennopozycyjną z przedziału [0, 1] zastosuj następujący wzór:
